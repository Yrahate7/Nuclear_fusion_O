...
CFLAGS_KERNEL	= $(KERNELFLAGS) -fpredictive-commoning -mtune=cortex-a15 -mfpu=neon-vfpv4
AFLAGS_KERNEL	=
...
KBUILD_CFLAGS += -Ofast -g0 -fmodulo-sched -fmodulo-sched-allow-regmoves -fno-tree-vectorize -fivopts -fno-inline-functions
endif
